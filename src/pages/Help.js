	...
	return (
		<div>
			...
			<div className="box-info">
					...
					<div className="col col-sm-7">
						...
						<ul>
							...
							<li data-i18n="AboutWhatIsMyDashWallet5">
								We cannot recover your funds or freeze your account if you visit a phishing site or
								lose your private key. Using a hardware wallet is MUCH safer as no one will ever
					...
					<div className="col col-sm-7">
						...
						<ul>
							...
							<li data-i18n="AboutNotABank5">
								You have an account with the bank or exchange and they decide how much money you can
								send, where you can send it, and how long to hold on a suspicious deposit. All for a
								fee.
							</li>
						</ul>
					</div>
					...
					<div className="col col-sm-7">
						...
						<ul>
							<li data-i18n="AboutInterface1">
								When you create an account on MyDashWallet you are generating a cryptographic set of
								numbers: your private key and your public key (address).
							</li>
							...
							<li data-i18n="AboutInterface5">
								If the site is modified, hacked, redirected, script injected and a hacker gets your
								private keys, he will get access to your funds and there is nothing anyone can do to
								help. You are your own bank! Only use small amounts or switch to using a hardware
								wallet.
							</li>
					...
					<div className="col col-sm-7">
						...
						<ul>
							...
							<li data-i18n="[html]AboutBlockchain5">
								...
								<a href="https://explorer.mydashwallet.org">https://explorer.mydashwallet.org</a> or
								one of the other supported explorers, you are seeing data on the blockchain, not in
				...
				<section className="row align-items-center">
					<div className="col col-sm-7">
						<h3 data-i18n="AboutPoint">If MyDashWallet can't do those things, what's the point?</h3>
						<ul>
					...
					<div className="col col-sm-7">
						...
						<ul>
							...
							<li data-i18n="[html]AboutScams5">
								...
								<a href="https://en.wikipedia.org/wiki/Fear_of_missing_out">FOMO</a> win over common
								sense. If something is very urgent, ask yourself "why?". It may be to create FOMO or
								prevent you from doing research.
							</li>
						</ul>
					</div>
					<div className="col col-sm-4 offset-sm-1">
						...
						<ul>
							...
							<li>
								<a href="https://youtu.be/phht73IvUDI?t=58" data-i18n="AboutPreferAVideo">
									Prefer a video walkthrough? Here's one for MyEtherWallet, MyDashWallet is similar
								</a>
							</li>
						</ul>
					</div>
